...
candidate1.save!
candidate2 = france.candidates.create(first_name: "Kevin", last_name: "Baker", location: "Montreal (🇨🇦)", job: "Ruby engineer", healthcare: "Canadian healthcare plans", other_benefits: "Canadian Pension Plan", overlap: "≃ 8 hours", area_median: "$60K", notice_period: "2 weeks",  timezone: "EDT GMT-4", job_status: "Passive", status: "autre2", next_steps: "I would like to get more involved in the leadership part of a team of software enginers", next_job:"Data scientist, Data engineer, ML/Data engineer", expected_wage: 57, softskills: "Managed and integrated a small team of 2 ruby backend engineers", practice: "Scrum, dev-Ops mindset with TDD", industry: "Saas", languages: ["Ruby", "Python"], tools: ["Rails", "SQL", "Heroku"], selected: false)
...
challenge1.save!
challenge2 = candidate1.challenges.create(description: "Build the backend in ruby from stratch using rails and migrated MySQL database at Karvi")
challenge2.save!
