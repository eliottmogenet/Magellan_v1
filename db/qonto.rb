...
req1 = Req.new(title: "Frontend engineer", company: "Qonto", languages: ["JavaScript", "Ember.js"], tools:  ["JS Frameworks"], company_description: "We're on a mission to build the best platform in the world for engineers to understand and scale their systems, applications, and teams.  We operate at high scale—trillions of data points per day—providing always-on alerting, metrics visualization, logs, and application tracing for tens of thousands of companies. Our engineering culture values pragmatism, honesty, and simplicity to solve hard problems the right way.")
req1.save!

p "creating users"
user1 = User.new(first_name: "Jordan", last_name: "Jalabert", job: "Tech recruiter", location: "Paris - France", email: "seb@lewagon.org", password: "seb@lewagon.org")
...
challenge1 = candidate1.challenges.create(description: "Setting up of a web server using Node.js and Express.js at Osana Salud")
challenge1.save!
challenge2 = candidate1.challenges.create(description: "Configuration  at Karvi")
challenge2.save!
challenge3 = candidate1.challenges.create(description: "Data catching with Redis at Karvi")
challenge3.save!
...
challenge4.save!
challenge5 = candidate2.challenges.create(description: "Created an MVP with frontend framework Ember.js, Vue.js and Vuex and Nuxt Js from scratch ")
challenge5.save!
