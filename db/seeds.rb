...
req1.save!
req2 = Req.new(title: "Data Scientist", company: "Voodoo", languages: ["Node.js", "Python"], tools:  ["AWS", "NoSQL", "Redis", "Prometheus"], company_description: "We're on a mission to build the best platform in the world for engineers to understand and scale their systems, applications, and teams.  We operate at high scale—trillions of data points per day—providing always-on alerting, metrics visualization, logs, and application tracing for tens of thousands of companies. Our engineering culture values pragmatism, honesty, and simplicity to solve hard problems the right way.")
req2.save!
req3 = Req.new(title: "Engineering manager", company: "Voodoo", languages: ["Node.js", "Python"], tools:  ["AWS", "NoSQL", "Redis", "Prometheus"], company_description: "We're on a mission to build the best platform in the world for engineers to understand and scale their systems, applications, and teams.  We operate at high scale—trillions of data points per day—providing always-on alerting, metrics visualization, logs, and application tracing for tens of thousands of companies. Our engineering culture values pragmatism, honesty, and simplicity to solve hard problems the right way.")
req3.save!
req4 = Req.new(title: "IT Security Engineer", company: "Voodoo", languages: ["Node.js", "Python"], tools:  ["AWS", "NoSQL", "Redis", "Prometheus"], company_description: "We're on a mission to build the best platform in the world for engineers to understand and scale their systems, applications, and teams.  We operate at high scale—trillions of data points per day—providing always-on alerting, metrics visualization, logs, and application tracing for tens of thousands of companies. Our engineering culture values pragmatism, honesty, and simplicity to solve hard problems the right way.")
req4.save!


p "creating users"
user1 = User.new(first_name: "Stéphanie", last_name: "Escande", job: "Tech recruiter", location: "Paris - France", email: "alison@datatog.com", password: "seb@lewagon.org")
user1.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/alison.png')), filename: 'alison.png')
user1.save!
user2 = User.new(first_name: "Cecile", last_name: "Soullier", job: "TA Manager", location: "Paris - France", email: "Jon@datadog.com", password: "Jon@lewagon.org")
user2.photo.attach(io: File.open(File.join(Rails.root,'app/assets/images/cecile.png')), filename: 'cecile.png')
user2.save!
user3 = User.new(first_name: "John", last_name: "Hasting", job: "Head of Data", location: "New York City - USA", email: "John@datadog.com", password: "John@lewagon.org")
